 ...
 */
@Slf4j
public class MyGenericObjectPool<T> extends BaseGenericObjectPool<T>
    ...
    public T borrowObject(long borrowMaxWaitMillis) throws Exception {
        ...
        log.info("before;idleObjects.size={};", idleObjects.size());
        AbandonedConfig ac = this.abandonedConfig;
        ...
        log.info("after;borrow_elapsed={}ms;create={};borrowMaxWaitMillis={};idleObjects.size={};object={};", (System.currentTimeMillis() - start), create, borrowMaxWaitMillis, idleObjects.size(), object);
        return object;
    }
    ...
    public void returnObject(T obj) {
        ...
        log.info("before;obj={};p={};idleObjects.size={};", obj, p, idleObjects.size());
        ...
        updateStatsReturn(activeTime);
        log.info("after;obj={};p={};idleObjects.size={};", obj, p, idleObjects.size());
    }
