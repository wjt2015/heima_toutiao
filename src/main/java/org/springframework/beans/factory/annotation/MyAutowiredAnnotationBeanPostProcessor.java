 ...
 *
 * <p>Note: A default MyAutowiredAnnotationBeanPostProcessor will be registered
 * by the "context:annotation-config" and "context:component-scan" XML tags.
 * Remove or turn off the default annotation configuration there if you intend
 * to specify a custom MyAutowiredAnnotationBeanPostProcessor bean definition.
...
public class MyAutowiredAnnotationBeanPostProcessor extends InstantiationAwareBeanPostProcessorAdapter
    ...
    /**
     * Create a new MyAutowiredAnnotationBeanPostProcessor
    ...
    public void postProcessMergedBeanDefinition(RootBeanDefinition beanDefinition, Class<?> beanType, String beanName) {
        if (beanType != null) {
            ...
            log.info("beanDefinition={};beanType={};beanName={};metadata={};", beanDefinition, beanType, beanName, metadata);
        }
    }
