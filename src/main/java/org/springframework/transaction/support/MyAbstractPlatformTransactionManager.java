...
public abstract class MyAbstractPlatformTransactionManager implements PlatformTransactionManager, Serializable {
    ...
    /** Constants instance for MyAbstractPlatformTransactionManager */
    private static final Constants constants = new Constants(MyAbstractPlatformTransactionManager.class);
     ...
     * as part of transaction commit. Hence, MyAbstractPlatformTransactionManager will trigger
