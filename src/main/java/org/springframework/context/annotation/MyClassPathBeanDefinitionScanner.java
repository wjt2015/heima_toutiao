...
public class MyClassPathBeanDefinitionScanner extends MyClassPathScanningCandidateComponentProvider {
    ...
    /**
     * Create a new {@code MyClassPathBeanDefinitionScanner} for the given bean factory.
     *
    ...
    /**
     * Create a new {@code MyClassPathBeanDefinitionScanner} for the given bean factory and
    ...
    protected Set<BeanDefinitionHolder> doScan(String... basePackages) {
        ...
        for (String basePackage : basePackages) {
            ...
            logger.info("basePackage={};candidates={};", basePackage, candidates);
        ...
        logger.info("scan_finish!elapsed={}ms;basePackages={};", (System.currentTimeMillis() - start), Arrays.asList(basePackages));
