...
public class MyAnnotationConfigApplicationContext extends MyGenericApplicationContext implements AnnotationConfigRegistry {
    ...
    /**
     * Create a new MyAnnotationConfigApplicationContext that needs to be populated
    ...
    /**
     * Create a new MyAnnotationConfigApplicationContext, deriving bean definitions
    ...
    /**
     * Create a new MyAnnotationConfigApplicationContext, scanning for bean definitions
