 ...
 *
 * <pre class="code">
 * MyGenericApplicationContext ctx = new MyGenericApplicationContext();
...
public class MyGenericApplicationContext extends AbstractMyApplicationContext implements BeanDefinitionRegistry {
    ...
    /**
     * Create a new MyGenericApplicationContext.
     * @see #registerBeanDefinition
     * @see #refresh
     */
    ...
    /**
     * Create a new MyGenericApplicationContext with the given parent.
     * @param parent the parent application context
     * @see #registerBeanDefinition
     * @see #refresh
     */
    public MyGenericApplicationContext(ApplicationContext parent) {
        this();
        setParent(parent);
    }
    ...
    protected final void refreshBeanFactory() throws IllegalStateException {
        if (!this.refreshed.compareAndSet(false, true)) {
            throw new IllegalStateException(
                    "MyGenericApplicationContext does not support multiple refresh attempts: just call 'refresh' once");
        }
