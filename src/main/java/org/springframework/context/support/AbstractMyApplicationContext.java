 ...
 */
@Slf4j
public abstract class AbstractMyApplicationContext extends DefaultResourceLoader
    ...
    /**
     * Create a new AbstractMyApplicationContext with no parent.
     */
    public AbstractMyApplicationContext() {
        this.resourcePatternResolver = getResourcePatternResolver();
    }

    /**
     * Create a new AbstractMyApplicationContext with the given parent context.
     *
     * @param parent the parent context
     */
    public AbstractMyApplicationContext(ApplicationContext parent) {
        this();
        setParent(parent);
    }
     ...
     *
     * @see org.springframework.context.support.AbstractMyApplicationContext#createEnvironment
     */
    @Override
    ...
    protected void publishEvent(Object event, ResolvableType eventType) {
        ...
        if (this.parent != null) {
            if (this.parent instanceof AbstractMyApplicationContext) {
                ((AbstractMyApplicationContext) this.parent).publishEvent(event, eventType);
            } else {
    ...
    public void addBeanFactoryPostProcessor(BeanFactoryPostProcessor postProcessor) {
        ...
        log.info("add;beanFactoryPostProcessors.size={};postProcessor={};", this.beanFactoryPostProcessors.size(), postProcessor);
    }
     ...
     * AbstractMyApplicationContext too; else, return the parent context itself.
     */
    protected MessageSource getInternalParentMessageSource() {
        return (getParent() instanceof AbstractMyApplicationContext) ?
                ((AbstractMyApplicationContext) getParent()).messageSource : getParent();
    }
