...
class MyPostProcessorRegistrationDelegate {
    ...
    public static void registerBeanPostProcessors(
            ConfigurableListableBeanFactory beanFactory, AbstractMyApplicationContext applicationContext) {
        ...
        beanFactory.addBeanPostProcessor(new MyApplicationListenerDetector(applicationContext));
    }
