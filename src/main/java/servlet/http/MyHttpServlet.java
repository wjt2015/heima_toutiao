...
import servlet.MyGenericServlet;
 ...
 * <code>MyHttpServlet</code> must override at least
...
public abstract class MyHttpServlet extends MyGenericServlet
{
    ...
    private Method[] getAllDeclaredMethods(Class<? extends MyHttpServlet> c) {

        Class<?> clazz = c;
        Method[] allMethods = null;

        while (!clazz.equals(MyHttpServlet.class)) {
